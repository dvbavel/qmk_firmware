...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_WIN] = LAYOUT_60_tsangan_hhkb(
		...
		KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, 
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LSFT, LT(_ORG_ALT, KC_GRV), 
		KC_TRNS, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RGUI, KC_RCTL
    ),
	...
	[_ORG_ALT] = LAYOUT_60_tsangan_hhkb(
		...
		KC_TRNS, KC_TRNS, RGB_MODE_FORWARD, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, 
